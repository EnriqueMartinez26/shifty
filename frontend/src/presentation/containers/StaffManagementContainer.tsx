    ...
    <div className="space-y-6 animate-in fade-in duration-700">
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center py-20 rounded-[3rem]"
          ...
          <p className="text-xs font-black uppercase tracking-widest" style={{ color: colors2000s.text.secondary }}>Sincronizando equipo...</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-20 rounded-[3rem] text-center"
          ...
          <p className="text-xs font-bold max-w-xs mx-auto mt-2" style={{ color: colors2000s.text.secondary }}>Probá con otro término de búsqueda o agregá un nuevo profesional.</p>
        </div>
      ) : (
