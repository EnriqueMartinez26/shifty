...
export const useUpdateSuperAdminStore = () => {
  const invalidateSuperAdmin = useInvalidateSuperAdmin();
  return useMutation({
    mutationFn: ({ storePublicId, payload }: { storePublicId: string; payload: UpdateSuperAdminStorePayload }) =>
...
export const useCreateSuperAdminStoreAdmin = () => {
  const invalidateSuperAdmin = useInvalidateSuperAdmin();
  return useMutation({
    mutationFn: ({ storePublicId, payload }: { storePublicId: string; payload: CreateSuperAdminStoreAdminPayload }) =>
...
export const useUpdateSuperAdminUser = () => {
  const invalidateSuperAdmin = useInvalidateSuperAdmin();
  return useMutation({
    mutationFn: ({ userPublicId, payload }: { userPublicId: string; payload: UpdateSuperAdminUserPayload }) =>
...
export const useSetSuperAdminGlobalAdmin = () => {
  ...
  return useMutation<SuperAdminUser, Error, { userPublicId: string; isGlobalAdmin: boolean }>({
    mutationFn: ({ userPublicId, isGlobalAdmin }) => superAdminService.setGlobalAdmin(userPublicId, isGlobalAdmin),
    onSuccess: () => invalidateSuperAdmin(),
  });
};
...
export const useUpdateSuperAdminPlan = () => {
  const invalidateSuperAdmin = useInvalidateSuperAdmin();
  return useMutation({
    mutationFn: ({ planPublicId, payload }: { planPublicId: string; payload: UpdateSuperAdminPlanPayload }) =>
...
export const useAssignSuperAdminSubscription = () => {
  ...
  >({
    mutationFn: ({ storePublicId, payload }) => superAdminService.assignSubscription(storePublicId, payload),
    onSuccess: () => invalidateSuperAdmin(),
  });
};
...
export const useUpdateSuperAdminCoupon = () => {
  const invalidateSuperAdmin = useInvalidateSuperAdmin();
  return useMutation({
    mutationFn: ({ couponPublicId, payload }: { couponPublicId: string; payload: UpdateSuperAdminCouponPayload }) =>
...
export const useRedeemSuperAdminCoupon = () => {
  const invalidateSuperAdmin = useInvalidateSuperAdmin();
  return useMutation<SuperAdminCouponRedemption, Error, { storePublicId: string; couponCode: string }>({
    mutationFn: ({ storePublicId, couponCode }) => superAdminService.redeemCoupon(storePublicId, couponCode),
    onSuccess: () => invalidateSuperAdmin(),
  });
};
