  ...
  return (
    ...
    >
      <div className="p-6 flex items-center gap-3">
        ...
        <div>
          <h2 className="font-black leading-none mb-1 uppercase tracking-tight" style={{ color: colors2000s.text.primary }}>
            Shifty
          </h2>
          <span className="text-[10px] uppercase tracking-wider font-bold" style={{ color: colors2000s.text.secondary }}>
            Admin Panel
          </span>
        </div>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-sm" style={{ color: isActive ? colors2000s.text.onOrange : colors2000s.text.primary }}>
                  {item.label}
                </span>
              </div>
      ...
      <div className="p-4 mt-auto" style={{ borderTop: `1px solid ${colors2000s.border.light}` }}>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-black truncate uppercase tracking-tight" style={{ color: colors2000s.text.primary }}>
              {user?.first_name || "Usuario"}
            </p>
            <p className="text-[10px] truncate font-bold" style={{ color: colors2000s.text.secondary }}>
              {user?.email}
            </p>
          </div>
        </div>
