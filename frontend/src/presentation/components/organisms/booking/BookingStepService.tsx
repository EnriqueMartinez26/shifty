...
export const BookingStepService: React.FC<BookingStepServiceProps> = ({ storePublicId, selectedId, onSelect }) => {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center h-48">
        ...
        <p className="text-sm font-black text-gray-500 uppercase tracking-widest">Cargando servicios...</p>
      </div>
    );
  }
