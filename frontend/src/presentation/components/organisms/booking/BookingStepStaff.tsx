...
import { User, ChevronLeft, Loader2, Check } from "lucide-react";
    ...
    <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-500">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-sm font-bold text-gray-500">Elegí tu profesional de preferencia.</p>
        </div>
      </div>

      <div className="grid gap-4">
        {staffList?.map((staff, idx) => {
          const isSelected = selectedId === staff.public_id;
          
          return (
            <button
              key={staff.public_id}
              onClick={() => onSelect(staff.public_id)}
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p 
                  ...
                  style={{ color: isSelected ? 'rgba(255,255,255,0.8)' : colors2000s.text.secondary }}
                >
