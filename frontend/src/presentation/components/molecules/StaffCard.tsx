  ...
  return (
    ...
    >
      ...
      <div className="absolute right-6 top-6">
        ...
        >
          {staff.isActive ? <CheckCircle2 size={12} className="text-emerald-500" /> : <XCircle size={12} className="text-gray-400" />}
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2 pt-3 border-t" style={{ borderColor: colors2000s.border.light }}>
          <span className="text-[9px] font-black uppercase tracking-widest text-gray-400">Servicios:</span>
        ...
        <div className="grid grid-cols-2 gap-3 pt-4 border-t" style={{ borderColor: colors2000s.border.light }}>
          <button
