  ...
  return (
    <div
      ...
      className={cn(
        ...
        hoverable &&
          'hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)] hover:scale-[1.01] active:scale-[0.99]',
...
export const SkeuoCardHeader: React.FC<{
  ...
  <div className="flex items-start justify-between gap-4 mb-4">
    <div className="flex items-center gap-3">
      ...
      <div>
        <h3 className="font-bold text-gray-800 text-base uppercase tracking-tight">{title}</h3>
