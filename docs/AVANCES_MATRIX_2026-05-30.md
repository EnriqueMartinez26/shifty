...
- Alcance de `docs/AVANCES_SHIFTY_2026-05-28.md`: no conviene leerlo como `100% implementado`; pagos, reportes y booking publico siguen parciales en el workspace actual.
