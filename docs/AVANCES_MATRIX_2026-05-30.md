...
- alcance funcional y documental descrito en `docs/AVANCES_SHIFTY_2026-05-28.md`
...
| 4. Flujo publico y OTP | implementado | `backend/modules/otp/*`, `backend/modules/public/*`, `frontend/src/presentation/hooks/usePublic.ts`, `frontend/src/presentation/pages/PublicBooking.tsx` | OTP y reserva publica integrados |
| 5. Pagos y senas | implementado | `backend/modules/payments/*`, `frontend/src/presentation/hooks/usePayments.ts`, `frontend/src/presentation/pages/Payments.tsx` | Incluye webhook, refund y reconciliacion |
...
| 7. Reportes | implementado | `backend/modules/reports/*`, `frontend/src/presentation/hooks/useReports.ts`, `frontend/src/presentation/pages/Reports.tsx` | Reportes por tienda y profesional presentes |
...
- Alcance de `docs/AVANCES_SHIFTY_2026-05-28.md`: `100% implementado` en el workspace actual.
...
3. correr smoke visual guiado sobre login, dashboard, settings, calendar, payments, ledger y booking publico
4. recien entonces fusionar o reemplazar la rama de trabajo actual
