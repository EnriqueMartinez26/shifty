...
- **Link de pago del panel:** sobre un turno terminal (cancelado, completado, ausente, vencido), o si el turno se cancela mientras se genera, `POST /payments/preferences/{id}` responde 409 `APPOINTMENT_NOT_PAYABLE`.
