...
def upgrade() -> None:
    op.add_column(
        "payments", sa.Column("original_amount", sa.Numeric(12, 2), nullable=True)
    )
    op.add_column(
        "payments", sa.Column("discount_amount", sa.Numeric(12, 2), nullable=True)
    )
    op.add_column(
        "payments", sa.Column("promotion_code", sa.String(length=50), nullable=True)
    )
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column(
            "promotion_id",
            sa.String(),
            sa.ForeignKey("store_promotions.id"),
            nullable=False,
        ),
        sa.Column(
            "appointment_id",
    ...
    op.create_index(
        "ix_promotion_redemptions_store_id", "promotion_redemptions", ["store_id"]
    )
    op.create_index(
        "ix_promotion_redemptions_promotion_id",
        "promotion_redemptions",
        ["promotion_id"],
    )
    op.create_index(
        "ix_promotion_redemptions_appointment_id",
        "promotion_redemptions",
        ["appointment_id"],
    )
    op.create_index(
        "ix_promotion_redemptions_client_id", "promotion_redemptions", ["client_id"]
    )
