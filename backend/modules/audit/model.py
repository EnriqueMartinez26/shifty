...
class AuditLog(Base):
    ...
    # Sobre qué entidad
    resource_type: Mapped[str] = mapped_column(String(100), index=True)  # ej: "Appointment"
    resource_id:   Mapped[str] = mapped_column(String(26),  index=True)  # public_id del recurso
