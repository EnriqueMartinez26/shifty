...
from modules.staff.schemas import StaffCreate, StaffUpdate, StaffResponse, ScheduleCreate, ScheduleResponse
...
async def create_staff(
    ...
    try:
        ...
        if not loaded:
            raise HTTPException(status_code=500, detail="No se pudo recargar el staff creado")
